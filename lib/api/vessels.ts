...
const seedVessels: Vessel[] = [
  {
    id: "v1",
    name: "تاجر هرمز | Hormoz Trader",
    type: "cargo",
    ownerId: "2",
    ownerName: "گروه دریایی پارسیان | Parsian Maritime Group",
    status: "active",
    ...
    beam: 28,
    draft: 9.5,
    homePort: "بندرعباس | Bandar Abbas",
    currentLocation: "خلیج فارس - تنگه هرمز | Persian Gulf – Strait of Hormuz",
    yearBuilt: 2008,
    dwt: 32000,
    grossTonnage: 21000,
    crewCapacity: 24,
    fuelType: "سوخت کم‌سولفور | Low-sulfur fuel",
    classSociety: "کلاس آی‌آر | IR Class",
    ...
    healthProfile: {
      ...
      safety: "attention",
      overallScore: 82,
      notes: "بازرسی تجهیزات نجات در بندر بعدی برنامه‌ریزی شده است. | Lifesaving equipment inspection scheduled at next port.",
    },
  },
  {
    id: "v2",
    name: "پیمایشگر خوزستان | Khuzestan Voyager",
    type: "tanker",
    ownerId: "2",
    ownerName: "گروه دریایی پارسیان | Parsian Maritime Group",
    status: "active",
    ...
    beam: 42,
    draft: 15,
    homePort: "بوشهر | Bushehr",
    currentLocation: "خلیج فارس - لنگرگاه صادراتی | Persian Gulf – Export anchorage",
    yearBuilt: 2012,
    dwt: 105000,
    grossTonnage: 60000,
    crewCapacity: 32,
    fuelType: "سوخت بسیار کم‌سولفور | Ultra-low sulfur fuel",
    classSociety: "ال‌آر | Lloyd's Register",
    ...
    healthProfile: {
      ...
      safety: "good",
      overallScore: 76,
      notes: "توصیه می‌شود پوشش بدنه در نخستین فرصت داک خشک ترمیم شود. | Recommend hull coating repairs at first dry-dock.",
    },
  },
  {
    id: "v3",
    name: "نسیم خزر | Caspian Breeze",
    type: "cargo",
    ownerId: "2",
    ownerName: "گروه دریایی پارسیان | Parsian Maritime Group",
    status: "pending",
    ...
    beam: 24,
    draft: 8,
    homePort: "خرمشهر | Khorramshahr",
    currentLocation: "بندر - در انتظار ترخیص | Port – Awaiting clearance",
    yearBuilt: 2019,
    dwt: 18000,
    grossTonnage: 12500,
    crewCapacity: 18,
    fuelType: "گازوئیل دریایی | Marine gasoil",
    classSociety: "کلاس آی‌آر | IR Class",
    ...
    healthProfile: {
      ...
      safety: "attention",
      overallScore: 80,
      notes: "مدارک مانورهای ایمنی برای تأیید نهایی ارسال شود. | Submit safety drill documentation for final approval.",
    },
  },
]
